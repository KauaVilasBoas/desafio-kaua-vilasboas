...
Para completar a etapa do desafio você terá que baixar a estrutura no repositório no github abaixo, resolver o desafio e entregá-lo no repositório no seu github.

### BAIXANDO A ESTRUTURA

Link do repositório para baixar a estrutura do desafio [link](https://github.com/lucaslsneves/desafio-estagio).

### ENTREGANDO O DESAFIO

Após resolver o desafio e validá-lo com os testes (mais detalhes nos tópicos abaixo), você terá que criar um repositório no [Github](https://github.com/) com o nome de `desafio-$seunome-$sobrenome` (substitua os nomes com $ pelo seu próprio nome e sobrenome). Deṕos disso, você pode enviar o link do seu repositório para que possamos validá-lo para os e-mails: `jorgesilva@ints.org.br` e `lucasneves@ints.org.br`
